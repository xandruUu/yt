    ...
    st.code(
        "\n".join(
            [
                ...
                f"HIGGSFIELD_REAL_GENERATION_ENABLED={settings.higgsfield_real_generation_enabled}",
                f"HIGGSFIELD_DEFAULT_MODEL={settings.higgsfield_default_model}",
                f"HIGGSFIELD_DEFAULT_TEST_DURATION_SECONDS={settings.higgsfield_default_test_duration_seconds}",
                f"HIGGSFIELD_WAIT_TIMEOUT={settings.higgsfield_wait_timeout}",
                f"HIGGSFIELD_WAIT_INTERVAL={settings.higgsfield_wait_interval}",
                f"HIGGSFIELD_KNOWN_CREDIT_BALANCE={settings.higgsfield_known_credit_balance}",
                f"HIGGSFIELD_DOWNLOAD_OUTPUTS={settings.higgsfield_download_outputs}",
